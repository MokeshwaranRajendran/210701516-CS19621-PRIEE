...
Sub Activity_Create(FirstTime As Boolean)
	...
	Main.cursor1 = Main.sql1.ExecQuery("SELECT * FROM tblUrban2")
For i = 0 To Main.cursor1.RowCount - 1
Main.cursor1.Position = i
    Table1.AddRow(Array As String(Main.cursor1.getString("uName"), Main.cursor1.getString("uFlood"), Main.cursor1.getString("uPopulation")))
	Next
